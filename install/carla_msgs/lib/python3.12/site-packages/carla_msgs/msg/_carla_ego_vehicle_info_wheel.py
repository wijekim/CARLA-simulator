...
class CarlaEgoVehicleInfoWheel(metaclass=Metaclass_CarlaEgoVehicleInfoWheel):
    ...
    def tire_friction(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'tire_friction' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def damping_rate(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'damping_rate' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def max_steer_angle(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'max_steer_angle' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def max_brake_torque(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'max_brake_torque' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def max_handbrake_torque(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'max_handbrake_torque' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
