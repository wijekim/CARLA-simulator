...
#ifndef CARLA_MSGS__SRV__DETAIL__GET_BLUEPRINTS__TYPE_SUPPORT_H_
#define CARLA_MSGS__SRV__DETAIL__GET_BLUEPRINTS__TYPE_SUPPORT_H_
...
#endif  // CARLA_MSGS__SRV__DETAIL__GET_BLUEPRINTS__TYPE_SUPPORT_H_
