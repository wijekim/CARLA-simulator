...
enum
{
  carla_msgs__srv__SpawnObject_Event__request__MAX_SIZE = 1
};
// response
enum
{
  carla_msgs__srv__SpawnObject_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SpawnObject in the package carla_msgs.
typedef struct carla_msgs__srv__SpawnObject_Event
{
  service_msgs__msg__ServiceEventInfo info;
  carla_msgs__srv__SpawnObject_Request__Sequence request;
  carla_msgs__srv__SpawnObject_Response__Sequence response;
} carla_msgs__srv__SpawnObject_Event;

// Struct for a sequence of carla_msgs__srv__SpawnObject_Event.
typedef struct carla_msgs__srv__SpawnObject_Event__Sequence
{
