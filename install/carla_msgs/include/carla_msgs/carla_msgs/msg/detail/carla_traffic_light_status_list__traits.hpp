...
// IWYU pragma: private, include "carla_msgs/msg/carla_traffic_light_status_list.hpp"
...
inline void to_flow_style_yaml(
  const CarlaTrafficLightStatusList & msg,
  std::ostream & out)
{
  out << "{";
  // member: traffic_lights
...
inline std::string to_yaml(const CarlaTrafficLightStatusList & msg, bool use_flow_style = false)
{
