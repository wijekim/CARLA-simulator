...
carla_msgs__msg__CarlaTrafficLightStatusList__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  carla_msgs__msg__CarlaTrafficLightStatusList * msg = (carla_msgs__msg__CarlaTrafficLightStatusList *)allocator.allocate(sizeof(carla_msgs__msg__CarlaTrafficLightStatusList), allocator.state);
  if (!msg) {
    return NULL;
  }
...
carla_msgs__msg__CarlaTrafficLightStatusList__Sequence__init(carla_msgs__msg__CarlaTrafficLightStatusList__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_msgs__msg__CarlaTrafficLightStatusList *)allocator.zero_allocate(size, sizeof(carla_msgs__msg__CarlaTrafficLightStatusList), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  carla_msgs__msg__CarlaTrafficLightStatusList__Sequence * array = (carla_msgs__msg__CarlaTrafficLightStatusList__Sequence *)allocator.allocate(sizeof(carla_msgs__msg__CarlaTrafficLightStatusList__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  carla_msgs__msg__CarlaTrafficLightStatusList__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    carla_msgs__msg__CarlaTrafficLightStatusList * data =
      (carla_msgs__msg__CarlaTrafficLightStatusList *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!carla_msgs__msg__CarlaTrafficLightStatusList__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          carla_msgs__msg__CarlaTrafficLightStatusList__fini(&output->data[i]);
        }
        return false;
      }
    }
