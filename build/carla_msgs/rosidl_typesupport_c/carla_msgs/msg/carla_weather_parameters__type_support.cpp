...
static const _CarlaWeatherParameters_type_support_symbol_names_t _CarlaWeatherParameters_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carla_msgs, msg, CarlaWeatherParameters)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carla_msgs, msg, CarlaWeatherParameters)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, carla_msgs, msg, CarlaWeatherParameters)() {
  return &::carla_msgs::msg::rosidl_typesupport_c::CarlaWeatherParameters_message_type_support_handle;
}
