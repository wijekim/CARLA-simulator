...
static const _DestroyObject_Event_type_support_symbol_names_t _DestroyObject_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carla_msgs, srv, DestroyObject_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carla_msgs, srv, DestroyObject_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, carla_msgs, srv, DestroyObject_Event)() {
  return &::carla_msgs::srv::rosidl_typesupport_c::DestroyObject_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t DestroyObject_service_type_support_handle = {
  ...
  &DestroyObject_Request_message_type_support_handle,
  &DestroyObject_Response_message_type_support_handle,
  &DestroyObject_Event_message_type_support_handle,
