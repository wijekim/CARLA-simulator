...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_CarlaEgoVehicleControl(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: control
  carla_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.control,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: control
  current_alignment +=
    carla_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.control, current_alignment);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_carla_msgs
max_serialized_size_key_CarlaEgoVehicleStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: control
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        carla_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_CarlaEgoVehicleControl(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
