  ...
  size_t current_alignment)
{
  ...
  // Member: attributes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        diagnostic_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_KeyValue(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
// functions for carla_msgs::srv::SpawnObject_Request already declared above

// functions for carla_msgs::srv::SpawnObject_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_carla_msgs
cdr_serialize(
  const carla_msgs::srv::SpawnObject_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carla_msgs::srv::SpawnObject_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        carla_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SpawnObject_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        carla_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SpawnObject_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = carla_msgs::srv::SpawnObject_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        carla_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SpawnObject_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        carla_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SpawnObject_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const carla_msgs::srv::SpawnObject_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<carla_msgs::srv::SpawnObject_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &carla_msgs::srv::typesupport_fastrtps_cpp::_SpawnObject_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carla_msgs, srv, SpawnObject_Event)() {
  return &carla_msgs::srv::typesupport_fastrtps_cpp::_SpawnObject_Event__handle;
}
...
static const rosidl_service_type_support_t _SpawnObject__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<carla_msgs::srv::SpawnObject_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<carla_msgs::srv::SpawnObject_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<carla_msgs::srv::SpawnObject_Event>(),
