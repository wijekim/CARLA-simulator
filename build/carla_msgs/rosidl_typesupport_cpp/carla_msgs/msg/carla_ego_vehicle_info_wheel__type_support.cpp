...
static const _CarlaEgoVehicleInfoWheel_type_support_symbol_names_t _CarlaEgoVehicleInfoWheel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carla_msgs, msg, CarlaEgoVehicleInfoWheel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carla_msgs, msg, CarlaEgoVehicleInfoWheel)),
  }
};
...
{
  return &::carla_msgs::msg::rosidl_typesupport_cpp::CarlaEgoVehicleInfoWheel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, carla_msgs, msg, CarlaEgoVehicleInfoWheel)() {
  return get_message_type_support_handle<carla_msgs::msg::CarlaEgoVehicleInfoWheel>();
}
