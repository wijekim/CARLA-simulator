...
static const _CarlaEgoVehicleInfo_type_support_symbol_names_t _CarlaEgoVehicleInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carla_msgs, msg, CarlaEgoVehicleInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carla_msgs, msg, CarlaEgoVehicleInfo)),
  }
};
...
{
  return &::carla_msgs::msg::rosidl_typesupport_cpp::CarlaEgoVehicleInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, carla_msgs, msg, CarlaEgoVehicleInfo)() {
  return get_message_type_support_handle<carla_msgs::msg::CarlaEgoVehicleInfo>();
}
