...
static const _GetBlueprints_Event_type_support_symbol_names_t _GetBlueprints_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carla_msgs, srv, GetBlueprints_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carla_msgs, srv, GetBlueprints_Event)),
  }
};
...
{
  return &::carla_msgs::srv::rosidl_typesupport_cpp::GetBlueprints_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, carla_msgs, srv, GetBlueprints_Event)() {
  return get_message_type_support_handle<carla_msgs::srv::GetBlueprints_Event>();
}
...
static const rosidl_service_type_support_t GetBlueprints_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<carla_msgs::srv::GetBlueprints_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<carla_msgs::srv::GetBlueprints_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<carla_msgs::srv::GetBlueprints_Event>(),
