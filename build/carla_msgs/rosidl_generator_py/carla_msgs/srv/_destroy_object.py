...
class Metaclass_DestroyObject_Event(type):
    """Metaclass of message 'DestroyObject_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__destroy_object__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__destroy_object__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__destroy_object__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__destroy_object__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__destroy_object__event
...
class DestroyObject_Event(metaclass=Metaclass_DestroyObject_Event):
    """Message class 'DestroyObject_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<carla_msgs/DestroyObject_Request, 1>',
        'response': 'sequence<carla_msgs/DestroyObject_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['carla_msgs', 'srv'], 'DestroyObject_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['carla_msgs', 'srv'], 'DestroyObject_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from carla_msgs.srv import DestroyObject_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, DestroyObject_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'DestroyObject_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from carla_msgs.srv import DestroyObject_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, DestroyObject_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'DestroyObject_Response'"
...
class Metaclass_DestroyObject(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _destroy_object.Metaclass_DestroyObject_Event._TYPE_SUPPORT is None:
                _destroy_object.Metaclass_DestroyObject_Event.__import_type_support__()
...
class DestroyObject(metaclass=Metaclass_DestroyObject):
    ...
    from carla_msgs.srv._destroy_object import DestroyObject_Event as Event
