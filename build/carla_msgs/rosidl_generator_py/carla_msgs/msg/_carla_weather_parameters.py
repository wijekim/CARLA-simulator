...
class CarlaWeatherParameters(metaclass=Metaclass_CarlaWeatherParameters):
    ...
    def cloudiness(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'cloudiness' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def precipitation(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'precipitation' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def precipitation_deposits(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'precipitation_deposits' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def wind_intensity(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'wind_intensity' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def fog_density(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'fog_density' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def fog_distance(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'fog_distance' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def wetness(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'wetness' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._wetness = value
    ...
    def sun_azimuth_angle(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'sun_azimuth_angle' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def sun_altitude_angle(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'sun_altitude_angle' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
