...
class CarlaEgoVehicleInfo(metaclass=Metaclass_CarlaEgoVehicleInfo):
    ...
    def max_rpm(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'max_rpm' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._max_rpm = value
    ...
    def moi(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'moi' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._moi = value
    ...
    def damping_rate_full_throttle(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'damping_rate_full_throttle' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def damping_rate_zero_throttle_clutch_engaged(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'damping_rate_zero_throttle_clutch_engaged' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def damping_rate_zero_throttle_clutch_disengaged(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'damping_rate_zero_throttle_clutch_disengaged' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def gear_switch_time(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'gear_switch_time' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def clutch_strength(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'clutch_strength' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def drag_coefficient(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'drag_coefficient' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
