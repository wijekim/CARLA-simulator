...
void fetch_function__CarlaEgoVehicleInfo__wheels(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const carla_msgs::msg::CarlaEgoVehicleInfoWheel *>(
    get_const_function__CarlaEgoVehicleInfo__wheels(untyped_member, index));
  auto & value = *reinterpret_cast<carla_msgs::msg::CarlaEgoVehicleInfoWheel *>(untyped_value);
  value = item;
}

void assign_function__CarlaEgoVehicleInfo__wheels(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<carla_msgs::msg::CarlaEgoVehicleInfoWheel *>(
    get_function__CarlaEgoVehicleInfo__wheels(untyped_member, index));
  const auto & value = *reinterpret_cast<const carla_msgs::msg::CarlaEgoVehicleInfoWheel *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CarlaEgoVehicleInfo_message_member_array[15] = {
  ...
  },
  {
    ...
    fetch_function__CarlaEgoVehicleInfo__wheels,  // fetch(index, &value) function pointer
    assign_function__CarlaEgoVehicleInfo__wheels,  // assign(index, value) function pointer
