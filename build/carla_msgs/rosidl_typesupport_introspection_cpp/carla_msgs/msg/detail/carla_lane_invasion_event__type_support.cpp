...
void fetch_function__CarlaLaneInvasionEvent__crossed_lane_markings(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int32_t *>(
    get_const_function__CarlaLaneInvasionEvent__crossed_lane_markings(untyped_member, index));
  auto & value = *reinterpret_cast<int32_t *>(untyped_value);
  value = item;
}

void assign_function__CarlaLaneInvasionEvent__crossed_lane_markings(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int32_t *>(
    get_function__CarlaLaneInvasionEvent__crossed_lane_markings(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CarlaLaneInvasionEvent_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__CarlaLaneInvasionEvent__crossed_lane_markings,  // fetch(index, &value) function pointer
    assign_function__CarlaLaneInvasionEvent__crossed_lane_markings,  // assign(index, value) function pointer
