...
[[deprecated("use carla_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const carla_msgs::srv::SpawnObject_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  carla_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use carla_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const carla_msgs::srv::SpawnObject_Event & msg)
{
  return carla_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<carla_msgs::srv::SpawnObject_Event>()
{
  return "carla_msgs::srv::SpawnObject_Event";
}

template<>
inline const char * name<carla_msgs::srv::SpawnObject_Event>()
{
  return "carla_msgs/srv/SpawnObject_Event";
}

template<>
struct has_fixed_size<carla_msgs::srv::SpawnObject_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<carla_msgs::srv::SpawnObject_Event>
  : std::integral_constant<bool, has_bounded_size<carla_msgs::srv::SpawnObject_Request>::value && has_bounded_size<carla_msgs::srv::SpawnObject_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<carla_msgs::srv::SpawnObject_Event>
  : std::true_type {};
