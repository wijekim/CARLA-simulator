...
{
public:
  explicit Init_SpawnObject_Event_response(::carla_msgs::srv::SpawnObject_Event & msg)
  : msg_(msg)
  {}
  ::carla_msgs::srv::SpawnObject_Event response(::carla_msgs::srv::SpawnObject_Event::_response_type arg)
  {
...
private:
  ::carla_msgs::srv::SpawnObject_Event msg_;
};

class Init_SpawnObject_Event_request
{
public:
  explicit Init_SpawnObject_Event_request(::carla_msgs::srv::SpawnObject_Event & msg)
  : msg_(msg)
  {}
  Init_SpawnObject_Event_response request(::carla_msgs::srv::SpawnObject_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SpawnObject_Event_request info(::carla_msgs::srv::SpawnObject_Event::_info_type arg)
  {
...
template<>
inline
auto build<::carla_msgs::srv::SpawnObject_Event>()
{
  return carla_msgs::srv::builder::Init_SpawnObject_Event_info();
}
