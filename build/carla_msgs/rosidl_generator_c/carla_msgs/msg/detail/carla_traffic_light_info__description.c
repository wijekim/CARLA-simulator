...
static char carla_msgs__msg__CarlaTrafficLightInfo__FIELD_NAME__id[] = "id";
static char carla_msgs__msg__CarlaTrafficLightInfo__FIELD_NAME__transform[] = "transform";
static char carla_msgs__msg__CarlaTrafficLightInfo__FIELD_NAME__trigger_volume[] = "trigger_volume";

static rosidl_runtime_c__type_description__Field carla_msgs__msg__CarlaTrafficLightInfo__FIELDS[] = {
  {
    {carla_msgs__msg__CarlaTrafficLightInfo__FIELD_NAME__id, 2, 2},
    {
  ...
  {
    {carla_msgs__msg__CarlaTrafficLightInfo__FIELD_NAME__transform, 9, 9},
    {
  ...
  {
    {carla_msgs__msg__CarlaTrafficLightInfo__FIELD_NAME__trigger_volume, 14, 14},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription carla_msgs__msg__CarlaTrafficLightInfo__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {carla_msgs__msg__CarlaBoundingBox__TYPE_NAME, 31, 31},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {carla_msgs__msg__CarlaTrafficLightInfo__FIELDS, 3, 3},
    },
    {carla_msgs__msg__CarlaTrafficLightInfo__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *carla_msgs__msg__CarlaTrafficLightInfo__get_individual_type_description_source(NULL),
