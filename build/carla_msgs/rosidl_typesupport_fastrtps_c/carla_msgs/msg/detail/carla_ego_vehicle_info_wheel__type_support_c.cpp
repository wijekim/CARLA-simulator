  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const carla_msgs__msg__CarlaEgoVehicleInfoWheel * ros_message = static_cast<const carla_msgs__msg__CarlaEgoVehicleInfoWheel *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_carla_msgs__msg__CarlaEgoVehicleInfoWheel(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  carla_msgs__msg__CarlaEgoVehicleInfoWheel * ros_message = static_cast<carla_msgs__msg__CarlaEgoVehicleInfoWheel *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_carla_msgs__msg__CarlaEgoVehicleInfoWheel(cdr, ros_message);
}
