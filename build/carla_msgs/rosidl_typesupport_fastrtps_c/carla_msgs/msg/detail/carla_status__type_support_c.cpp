...
bool cdr_serialize_carla_msgs__msg__CarlaStatus(
  const carla_msgs__msg__CarlaStatus * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
bool cdr_deserialize_carla_msgs__msg__CarlaStatus(
  eprosima::fastcdr::Cdr & cdr,
  carla_msgs__msg__CarlaStatus * ros_message)
{
  // Field name: frame
  {
    cdr >> ros_message->frame;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
bool cdr_serialize_key_carla_msgs__msg__CarlaStatus(
  const carla_msgs__msg__CarlaStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: frame
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
size_t get_serialized_size_key_carla_msgs__msg__CarlaStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CarlaStatus__ros_msg_type * ros_message = static_cast<const _CarlaStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
size_t max_serialized_size_key_carla_msgs__msg__CarlaStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const carla_msgs__msg__CarlaStatus * ros_message = static_cast<const carla_msgs__msg__CarlaStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_carla_msgs__msg__CarlaStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  carla_msgs__msg__CarlaStatus * ros_message = static_cast<carla_msgs__msg__CarlaStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_carla_msgs__msg__CarlaStatus(cdr, ros_message);
}
