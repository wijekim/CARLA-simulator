  ...
  carla_msgs__msg__CarlaBoundingBox * ros_message)
{
  // Field name: center
  {
    cdr_deserialize_geometry_msgs__msg__Vector3(cdr, &ros_message->center);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = carla_msgs__msg__CarlaBoundingBox;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const carla_msgs__msg__CarlaBoundingBox * ros_message = static_cast<const carla_msgs__msg__CarlaBoundingBox *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_carla_msgs__msg__CarlaBoundingBox(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  carla_msgs__msg__CarlaBoundingBox * ros_message = static_cast<carla_msgs__msg__CarlaBoundingBox *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_carla_msgs__msg__CarlaBoundingBox(cdr, ros_message);
}
...
static size_t _CarlaBoundingBox__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_carla_msgs__msg__CarlaBoundingBox(
