...
bool cdr_serialize_carla_msgs__msg__CarlaCollisionEvent(
  const carla_msgs__msg__CarlaCollisionEvent * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
bool cdr_deserialize_carla_msgs__msg__CarlaCollisionEvent(
  eprosima::fastcdr::Cdr & cdr,
  carla_msgs__msg__CarlaCollisionEvent * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: normal_impulse
  {
    cdr_deserialize_geometry_msgs__msg__Vector3(cdr, &ros_message->normal_impulse);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
bool cdr_serialize_key_carla_msgs__msg__CarlaCollisionEvent(
  const carla_msgs__msg__CarlaCollisionEvent * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
size_t get_serialized_size_key_carla_msgs__msg__CarlaCollisionEvent(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CarlaCollisionEvent__ros_msg_type * ros_message = static_cast<const _CarlaCollisionEvent__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
size_t max_serialized_size_key_carla_msgs__msg__CarlaCollisionEvent(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const carla_msgs__msg__CarlaCollisionEvent * ros_message = static_cast<const carla_msgs__msg__CarlaCollisionEvent *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_carla_msgs__msg__CarlaCollisionEvent(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  carla_msgs__msg__CarlaCollisionEvent * ros_message = static_cast<carla_msgs__msg__CarlaCollisionEvent *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_carla_msgs__msg__CarlaCollisionEvent(cdr, ros_message);
}
