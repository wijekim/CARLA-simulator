...
bool cdr_serialize_carla_msgs__msg__CarlaEgoVehicleControl(
  const carla_msgs__msg__CarlaEgoVehicleControl * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_carla_msgs__msg__CarlaEgoVehicleControl(
  eprosima::fastcdr::Cdr & cdr,
  carla_msgs__msg__CarlaEgoVehicleControl * ros_message);
...
bool cdr_serialize_key_carla_msgs__msg__CarlaEgoVehicleControl(
  const carla_msgs__msg__CarlaEgoVehicleControl * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_carla_msgs__msg__CarlaEgoVehicleControl(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_carla_msgs__msg__CarlaEgoVehicleControl(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_carla_msgs__msg__CarlaEgoVehicleStatus(
  const carla_msgs__msg__CarlaEgoVehicleStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: control
  {
    cdr_serialize_carla_msgs__msg__CarlaEgoVehicleControl(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
bool cdr_deserialize_carla_msgs__msg__CarlaEgoVehicleStatus(
  eprosima::fastcdr::Cdr & cdr,
  carla_msgs__msg__CarlaEgoVehicleStatus * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: control
  {
    cdr_deserialize_carla_msgs__msg__CarlaEgoVehicleControl(cdr, &ros_message->control);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = carla_msgs__msg__CarlaEgoVehicleStatus;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
bool cdr_serialize_key_carla_msgs__msg__CarlaEgoVehicleStatus(
  const carla_msgs__msg__CarlaEgoVehicleStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: control
  {
    cdr_serialize_key_carla_msgs__msg__CarlaEgoVehicleControl(
      &ros_message->control, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
size_t get_serialized_size_key_carla_msgs__msg__CarlaEgoVehicleStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CarlaEgoVehicleStatus__ros_msg_type * ros_message = static_cast<const _CarlaEgoVehicleStatus__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: control
  current_alignment += get_serialized_size_key_carla_msgs__msg__CarlaEgoVehicleControl(
    &(ros_message->control), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
size_t max_serialized_size_key_carla_msgs__msg__CarlaEgoVehicleStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: control
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_carla_msgs__msg__CarlaEgoVehicleControl(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const carla_msgs__msg__CarlaEgoVehicleStatus * ros_message = static_cast<const carla_msgs__msg__CarlaEgoVehicleStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_carla_msgs__msg__CarlaEgoVehicleStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  carla_msgs__msg__CarlaEgoVehicleStatus * ros_message = static_cast<carla_msgs__msg__CarlaEgoVehicleStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_carla_msgs__msg__CarlaEgoVehicleStatus(cdr, ros_message);
}
...
static size_t _CarlaEgoVehicleStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_carla_msgs__msg__CarlaEgoVehicleStatus(
