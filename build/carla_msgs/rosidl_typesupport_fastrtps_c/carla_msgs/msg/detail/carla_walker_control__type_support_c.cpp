...
bool cdr_serialize_carla_msgs__msg__CarlaWalkerControl(
  const carla_msgs__msg__CarlaWalkerControl * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
bool cdr_deserialize_carla_msgs__msg__CarlaWalkerControl(
  eprosima::fastcdr::Cdr & cdr,
  carla_msgs__msg__CarlaWalkerControl * ros_message)
{
  // Field name: direction
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = carla_msgs__msg__CarlaWalkerControl;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
bool cdr_serialize_key_carla_msgs__msg__CarlaWalkerControl(
  const carla_msgs__msg__CarlaWalkerControl * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: direction
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
size_t get_serialized_size_key_carla_msgs__msg__CarlaWalkerControl(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CarlaWalkerControl__ros_msg_type * ros_message = static_cast<const _CarlaWalkerControl__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
size_t max_serialized_size_key_carla_msgs__msg__CarlaWalkerControl(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const carla_msgs__msg__CarlaWalkerControl * ros_message = static_cast<const carla_msgs__msg__CarlaWalkerControl *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_carla_msgs__msg__CarlaWalkerControl(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  carla_msgs__msg__CarlaWalkerControl * ros_message = static_cast<carla_msgs__msg__CarlaWalkerControl *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_carla_msgs__msg__CarlaWalkerControl(cdr, ros_message);
}
...
static size_t _CarlaWalkerControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_carla_msgs__msg__CarlaWalkerControl(
