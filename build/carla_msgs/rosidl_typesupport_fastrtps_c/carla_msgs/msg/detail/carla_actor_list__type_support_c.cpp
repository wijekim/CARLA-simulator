...
bool cdr_serialize_carla_msgs__msg__CarlaActorInfo(
  const carla_msgs__msg__CarlaActorInfo * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_carla_msgs__msg__CarlaActorInfo(
  eprosima::fastcdr::Cdr & cdr,
  carla_msgs__msg__CarlaActorInfo * ros_message);
...
bool cdr_serialize_key_carla_msgs__msg__CarlaActorInfo(
  const carla_msgs__msg__CarlaActorInfo * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_carla_msgs__msg__CarlaActorInfo(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_carla_msgs__msg__CarlaActorInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_carla_msgs__msg__CarlaActorList(
  const carla_msgs__msg__CarlaActorList * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: actors
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_carla_msgs__msg__CarlaActorInfo(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
bool cdr_deserialize_carla_msgs__msg__CarlaActorList(
  eprosima::fastcdr::Cdr & cdr,
  carla_msgs__msg__CarlaActorList * ros_message)
{
  // Field name: actors
  {
    uint32_t cdrSize;
    ...
    auto array_ptr = ros_message->actors.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_carla_msgs__msg__CarlaActorInfo(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
bool cdr_serialize_key_carla_msgs__msg__CarlaActorList(
  const carla_msgs__msg__CarlaActorList * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: actors
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_carla_msgs__msg__CarlaActorInfo(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
size_t get_serialized_size_key_carla_msgs__msg__CarlaActorList(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CarlaActorList__ros_msg_type * ros_message = static_cast<const _CarlaActorList__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: actors
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_carla_msgs__msg__CarlaActorInfo(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
size_t max_serialized_size_key_carla_msgs__msg__CarlaActorList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: actors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_carla_msgs__msg__CarlaActorInfo(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const carla_msgs__msg__CarlaActorList * ros_message = static_cast<const carla_msgs__msg__CarlaActorList *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_carla_msgs__msg__CarlaActorList(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  carla_msgs__msg__CarlaActorList * ros_message = static_cast<carla_msgs__msg__CarlaActorList *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_carla_msgs__msg__CarlaActorList(cdr, ros_message);
}
