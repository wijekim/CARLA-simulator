...
bool cdr_serialize_carla_msgs__msg__CarlaTrafficLightInfoList(
  const carla_msgs__msg__CarlaTrafficLightInfoList * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: traffic_lights
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_carla_msgs__msg__CarlaTrafficLightInfo(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
bool cdr_deserialize_carla_msgs__msg__CarlaTrafficLightInfoList(
  eprosima::fastcdr::Cdr & cdr,
  carla_msgs__msg__CarlaTrafficLightInfoList * ros_message)
{
  // Field name: traffic_lights
  {
    uint32_t cdrSize;
    ...
    auto array_ptr = ros_message->traffic_lights.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_carla_msgs__msg__CarlaTrafficLightInfo(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
bool cdr_serialize_key_carla_msgs__msg__CarlaTrafficLightInfoList(
  const carla_msgs__msg__CarlaTrafficLightInfoList * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: traffic_lights
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_carla_msgs__msg__CarlaTrafficLightInfo(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
size_t get_serialized_size_key_carla_msgs__msg__CarlaTrafficLightInfoList(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CarlaTrafficLightInfoList__ros_msg_type * ros_message = static_cast<const _CarlaTrafficLightInfoList__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: traffic_lights
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_carla_msgs__msg__CarlaTrafficLightInfo(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
size_t max_serialized_size_key_carla_msgs__msg__CarlaTrafficLightInfoList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: traffic_lights
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_carla_msgs__msg__CarlaTrafficLightInfo(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const carla_msgs__msg__CarlaTrafficLightInfoList * ros_message = static_cast<const carla_msgs__msg__CarlaTrafficLightInfoList *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_carla_msgs__msg__CarlaTrafficLightInfoList(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  carla_msgs__msg__CarlaTrafficLightInfoList * ros_message = static_cast<carla_msgs__msg__CarlaTrafficLightInfoList *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_carla_msgs__msg__CarlaTrafficLightInfoList(cdr, ros_message);
}
