...
bool cdr_serialize_carla_msgs__msg__CarlaWeatherParameters(
  const carla_msgs__msg__CarlaWeatherParameters * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
bool cdr_deserialize_carla_msgs__msg__CarlaWeatherParameters(
  eprosima::fastcdr::Cdr & cdr,
  carla_msgs__msg__CarlaWeatherParameters * ros_message)
{
  // Field name: cloudiness
  {
    cdr >> ros_message->cloudiness;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = carla_msgs__msg__CarlaWeatherParameters;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
bool cdr_serialize_key_carla_msgs__msg__CarlaWeatherParameters(
  const carla_msgs__msg__CarlaWeatherParameters * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: cloudiness
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
size_t get_serialized_size_key_carla_msgs__msg__CarlaWeatherParameters(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CarlaWeatherParameters__ros_msg_type * ros_message = static_cast<const _CarlaWeatherParameters__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_carla_msgs
size_t max_serialized_size_key_carla_msgs__msg__CarlaWeatherParameters(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const carla_msgs__msg__CarlaWeatherParameters * ros_message = static_cast<const carla_msgs__msg__CarlaWeatherParameters *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_carla_msgs__msg__CarlaWeatherParameters(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  carla_msgs__msg__CarlaWeatherParameters * ros_message = static_cast<carla_msgs__msg__CarlaWeatherParameters *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_carla_msgs__msg__CarlaWeatherParameters(cdr, ros_message);
}
...
static size_t _CarlaWeatherParameters__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_carla_msgs__msg__CarlaWeatherParameters(
